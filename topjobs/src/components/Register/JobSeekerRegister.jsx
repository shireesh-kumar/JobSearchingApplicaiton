            ...
            <div id="registerFormContainer" className="card shadow-lg align-self-center">
                <div className="card-body" align="center">
                    <form onSubmit={RegisterHandler}>
                        ...
                        <Link id="loginLink" to="/JobSeekerLogin"><div>Already have an account? Log in</div></Link>
                        <Link id="loginLink" to="/RecruiterRegister"><div>Are you a recruiter? Register here</div></Link>
                    </form>
                </div>
            </div>
        </div>
