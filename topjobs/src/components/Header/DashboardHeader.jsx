...
export default function DashboardHeader(props) {
    const LogoutHandler = () => {
        ...
        localStorage.setItem('topJobsRole', JSON.stringify(null))
    }
            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <div className="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
                        <form id="searchBarForm" className="d-flex mr-auto py-2">
                            <select id="dashboardCategories" className="form-select me-2" aria-label="Default select example">
